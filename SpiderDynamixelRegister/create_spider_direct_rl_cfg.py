...
class SpiderEnvCfg(DirectRLEnvCfg):
    ...
    energy_cost_scale: float = 0.005#0.05 #/ 3.0
    # dof_limit_scale: float = 1 / 20.0
    actions_cost_scale: float = 0.0005# 0.005
...
class SpiderEnv(DirectRLEnv):
    ...
    def _compute_intermediate_values(self):
        ...
        # print("joint efforts : ", self.robot.data.applied_torque)
...
def compute_rewards(
    ...
    body_speed = torch.norm(body_vel[:, :2], dim=1)
    print("body_speed : ", body_speed)
